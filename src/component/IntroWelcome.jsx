...
export default function IntroWelcom() {
    ...
    <section name="intro-text" className="inline-flex z-0 px-4 w-fit md:border-purple-500 md:border-2 align-middle justify-center flex-col gap-4 md:gap-8 lg:gap-12 py-4 md:py-8 lg:py-12  bg-opacity-50  shadow-lg">
